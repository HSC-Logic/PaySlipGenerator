...
export function createBasicSlip(): PaymentSlip {
  return {
    ...
    payment: { documentType: 'payment-slip', customDocumentType: '', date: '2026-08-31', reference: 'PAY/001', title: 'Consulting services', method: 'Cash', customPaymentMethod: '', status: 'draft', paidDate: '', paidReference: '', bankName: '', transactionReference: '', notes: '', adjustment: 0, currency: 'LKR', sealText: '', paperSize: 'a4', orientation: 'portrait' },
