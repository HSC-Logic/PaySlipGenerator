...
const source: PaymentSlip = {
  ...
  payment: { date: '2026-01-01', reference: 'PS-2026-0001', title: 'Service', method: 'Bank Transfer', bankName: 'Bank', transactionReference: 'OLD-TX', notes: '', adjustment: 0, currency: 'LKR', sealText: '', paperSize: 'a4', orientation: 'portrait' },
