...
const source: PaymentSlip = {
  ...
  payment: { documentType: 'other', customDocumentType: 'Payment Voucher', date: '2026-01-01', reference: 'PS-2026-0001', title: 'Service', method: 'Other', customPaymentMethod: 'Wise', status: 'draft', paidDate: '', paidReference: '', bankName: 'Bank', transactionReference: 'OLD-TX', notes: '', adjustment: 0, currency: 'LKR', sealText: '', paperSize: 'a4', orientation: 'portrait' },
...
describe('create similar slip', () => {
  it('deep-clones nested data and assigns a new transaction identity', () => {
    ...
    expect(similar.payment).toMatchObject({ documentType: 'other', customDocumentType: 'Payment Voucher', method: 'Other', customPaymentMethod: 'Wise' })
